...
const Banner = () => {
  return (
    <div className="relative  min-h-screen  flex justify-center items-center bg-[url('/src/assets/img/banner3.jpg')] bg-cover bg-center">
      ...
      <div className='relative z-10  w-full md:w-2/4  bg-black/50 text-white p-10 mx-5 space-y-5 rounded-lg hover:scale-110 duration-300' >
        ...
        <button className='bg-emerald-500 px-5 py-2  rounded-lg hover:bg-white  hover:text-black transition duration-300 ease-in-out  cursor-pointer'>Order Now</button>
      </div>
    </div>
  );
}
